...
interface MessageDao {
    ...
    @Query("SELECT * FROM messages WHERE channel LIKE :channelId ORDER BY createdAt DESC LIMIT :limit")
    suspend fun getInitialMessages(channelId: String, limit: Int): List<MessageEntity>
