...
class VoiceChannelViewHolder(parent: ViewGroup) : BaseChannelViewHolder<ChannelItemBinding, Channel.VoiceChannel>(
    ChannelItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
) {
    override fun onBind(channel: Channel.VoiceChannel) {
