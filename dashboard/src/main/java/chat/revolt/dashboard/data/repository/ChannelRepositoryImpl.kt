...
class ChannelRepositoryImpl(
    ...
    override suspend fun fetchMessages(channelId: String, request: FetchMessagesRequest): List<Message> {
        return mapper.mapToResponse(dataSource.fetchMessages(channelId, mapper.mapToRequest(request)))
    }
}